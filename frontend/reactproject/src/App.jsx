    ...
    <Router>
      ...
      <div className="main">
        <Routes>
          ...
          <Route exact path="/edit" element={<EditUser product={product} clearProduct={clearProduct} selectProduct={selectProduct}/>}/>
          <Route exact path="/details" element={<UserDetails product={product}/>}/>
        </Routes>
      </div>
      <Footer />
    </Router>
